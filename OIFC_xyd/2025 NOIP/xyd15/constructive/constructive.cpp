...
int main() {
    ...
    while (T--) {
        fin >> n;
        switch (n) {
            case 2: case 3: case 4: case 6: fout << "-1\n"; break;
            case 1: fout << "1\n"; break;
            case 5: fout << "1 5 3 2 4\n"; break;
            case 10: fout << "9 1 5 3 7 6 2 8 4 10\n"; break;
            case 11: fout << "9 1 11 5 3 7 6 2 8 4 10\n"; break;
            case 12: fout << "9 1 11 5 3 7 6 2 4 8 12 10\n"; break;
            default:
            for (int i = 9; i <= n; i += 4)
                fout << i << ' ';
