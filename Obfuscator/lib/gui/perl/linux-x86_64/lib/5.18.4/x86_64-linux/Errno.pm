...
"x86_64-linux-3.16.0-30-generic" or
	die "Errno architecture (x86_64-linux-3.16.0-30-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
