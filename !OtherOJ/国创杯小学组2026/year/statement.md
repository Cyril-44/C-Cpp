...
$t \le 3\times10^5$，$m \le 10^{17}$，$n \le 10^9$，$a < b < c \le 10^8$。

**以下表格中 $N$ 表示单组测试点中所有测试数据 $n$ 的总和。**

| 测试点 | $t \le$ | $m \le$ | $n \le$ | $N \le$ | $a,b,c \le $ | 特殊性质 |
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| $1\sim5$   | $3\times10^5$ | $10^3$    | $1$    | $3\times10^5$    | $10^2$ | 无 |
| $6\sim10$  | $10^3$        | ^         | $10^2$ | $10^3$           | $10^3$ | ^ |
| $11\sim13$ | ^             | $10^6$    | $10^3$ | $10^4$           | $10^6$ | ^ |
| $14\sim19$ | ^             | $10^{15}$ | $10^5$ | $10^6$           | ^      | ^ |
| $20\sim25$ | $3\times10^5$ | $10^{17}$ | $10^9$ | $3\times10^{14}$ | $10^8$ | ^ |

特殊性质 A：保证该测试点下所有测试数据中的 $m$ 都被 $c$ 整除。

## 提示

如果你认为程序时限较紧，可以考虑使用 `scanf`/`printf` 或参考选手目录下的 _year/year.cpp_ 优化输入输出效率。
