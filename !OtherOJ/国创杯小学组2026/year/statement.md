...
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| $1,2$     | $3\times10^5$ | $10^3$    | $1$    | $3\times10^5$    | $10^2$ | 无 |
| $3,4$     | $10^3$        | ^         | $10^2$ | $10^3$           | $10^3$ | ^ |
| $5$       | ^             | $10^6$    | $10^3$ | $10^4$           | $10^6$ | ^ |
| $6,7$     | ^             | $10^{15}$ | $10^5$ | $10^6$           | ^      | ^ |
| $8\sim10$ | $3\times10^5$ | $10^{17}$ | $10^9$ | $3\times10^{14}$ | $10^8$ | ^ |

## 提示

如果你认为程序运行时限较紧，建议使用 `scanf`/`printf`、关闭同步流、或使用选手目录提供的 _year/year.cpp_ 模板，以优化输入输出效率。
