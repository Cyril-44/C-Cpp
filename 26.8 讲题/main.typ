...
我们使用类似于猫树的思想，即在线段树上的一个分治区间，维护所有跨过区间终点的线段。#pause
...
第二点，我们使用线段树维护 bot 的评分和二元组, 这样每次修改就是 $cal(O)(log n)$ 的。#pagebreak()

第三点，我们结算“活动”的贡献的时候，是询问形如从 $t_0$ 一直到现在的矩阵乘积。这个玩意让我们想到了树，所以直接动态倍增，就可以快速求解了。
